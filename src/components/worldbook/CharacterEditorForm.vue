...
/**
 * 父页面需要知道表单何时发生变化，以便展示未保存提示和实时状态。
      ...
      <NForm label-placement="top" :show-feedback="false">
        ...
        <NFormItem label="私密穿孔">
          <div class="array-field">
            ...
            >
              ...
              <NButton text type="error" @click="removeStringItem(formData.intimate_details.piercings_intimate, index)">
                <template #icon>
                  <NIcon><RemoveOutline /></NIcon>
                </template>
              </NButton>
            </div>
            <NButton size="small" quaternary type="primary" @click="addStringItem(formData.intimate_details.piercings_intimate)">
              添加私密穿孔
            </NButton>
          </div>
        </NFormItem>
        ...
        <NFormItem label="偏好风格">
          <div class="array-field">
            ...
            <NButton size="small" quaternary type="primary" @click="addStringItem(formData.intimacy_settings.preferred_style)">
              添加偏好风格
            </NButton>
          </div>
        </NFormItem>
        ...
        <NFormItem label="慢性病">
          <div class="array-field">
            ...
            <NButton size="small" quaternary type="primary" @click="addStringItem(formData.scars_conditions.chronic_disease)">
              添加慢性病
            </NButton>
          </div>
        </NFormItem>
